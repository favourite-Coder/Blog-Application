...
<section class="featured">
    <div class="container featured_container">
        ...
        <div class="post_info">
            <a href="category_posts.php" class="category_button">Wild Life</a>
            <h2 class="post_title"><a href="post.php">Lorem ipsum dolor, sit amet consectetur
                    adipisicing elit. </a></h2>
            <p class="post_body">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis blanditiis
                illum, error nemo dolor modi repellendus? Beatae qui quae voluptatum animi sapiente
                non rem aliquam, iusto quod! A, ducimus esse?
            </p>
            <div class="post_author">
                ...
                <div class="post_author-info">
                    <h5>By: Chris Humpson</h5>
                    <small>Jan 1, 2024 - 09:55</small>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container posts_container">
        ...
        <article class="post">
            ...
            <div class="post_info">
                <a href="category_posts.php" class="category_button">Wild Life</a>
                <h3 class="post_title">
                    <a href="post.php">Lorem um, dolor sit amet consectetur
                        adipisicing elit. Et, deleniti facilis.</a>
                </h3>
                <p class="post_body">
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Magni ullam
                    inventore, saepe dolores quam maxime neque? Iste doloribus quis facilis!
                </p>
                <div class="post_author">
                    <div class="post_author-avatar">
                    ...
                    <div class="post_author-info">
                        <h5>By: Ernest White</h5>
                        <small>Jan 1, 2024 - 10:57</small>
                    </div>
                </div>
            </div>
        </article>
